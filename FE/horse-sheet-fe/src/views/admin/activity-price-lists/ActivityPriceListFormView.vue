  ...
  <div class="activity-price-list-form">
    <div class="card">
      <div class="card-header">
        <h2 class="card-title">{{ isEdit ? 'Edit Activity Price List' : 'Create New Activity Price List' }}</h2>
        <router-link to="/admin/activity-price-lists" class="btn btn-secondary">Back to List</router-link>
      </div>
      ...
      <form v-else @submit.prevent="handleSubmit">
        ...
        <div class="form-actions">
          ...
          <router-link to="/admin/activity-price-lists" class="btn btn-secondary">Cancel</router-link>
        </div>
      </form>
    </div>
  </div>
